...
- The tutorial is managed by the [Tutorial.json file](stm-unity/Assets/Resources/Tutorial/Tutorial.json). To recreate the tutorial, use the option available on the Canvas\Team Management\Tutorial object, using the TutorialController. Text for tutorials is located in the SportsTeamManagerTutorial Spreadsheet in Resources/Tutorial/SportsTeamManagerTutorial.xlsx
