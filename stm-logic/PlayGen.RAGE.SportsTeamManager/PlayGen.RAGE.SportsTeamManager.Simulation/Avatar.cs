...
namespace PlayGen.RAGE.SportsTeamManager.Simulation
{
	...
	public class Avatar
	{
		...
		public void UpdateAvatarBeliefs(CrewMember crewMember)
		{
			...
			crewMember.UpdateSingleBelief(NPCBeliefs.AvatarHeight.GetDescription(), Height.ToString());
			...
			crewMember.UpdateSingleBelief(NPCBeliefs.AvatarWeight.GetDescription(), Weight.ToString());
