...
namespace TrackerAssetPackage
{
    using TrackerAssetPackage;
    using TrackerAssetPackage.Exceptions;
    using TrackerAssetPackage.Utils;
    using System;
    ...
    public class TrackerAsset : BaseAsset
    {
        ...
        public void Trace(TrackerEvent trace)
        {
            if (!this.Started)
				if (StrictMode)
				{
					throw (TrackerException)Activator.CreateInstance(typeof(TrackerException), "Tracker has not been started");
				}
				else
				{
					Log(Severity.Warning, "Tracker has not been started");
				}
